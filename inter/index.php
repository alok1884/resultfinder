...
<div class="container-fluid p-5">
    <div class="card">
    <div class="card-header bg-info text-light"><h5>INTERMEDIATE ANNUAL EXAMINATION RESULT 2020</h5></div>
...
if(isset($_GET['view'])):
    $roll = $_GET['roll'];
    $call = mysqli_query($new->connect,"select * from intermidiate where id = '$roll'");
  ...
  <div class="modal-dialog modal-lg">
   <div class="modal-content">
      <div class="modal-header bg-info text-light">
        <h5 class="modal-title">INTERMEDIATE ANNUAL EXAMINATION RESULT 2020</h5>
